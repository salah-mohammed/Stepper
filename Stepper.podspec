...
Pod::Spec.new do |s|
  ...
  s.description  = "Stepper"

  s.homepage     = "https://github.com/salah-mohammed/Stepper"
  ...
  s.source       = { :git => "https://github.com/salah-mohammed/Stepper.git", :tag => "#{s.version}",:branch => "master"}
